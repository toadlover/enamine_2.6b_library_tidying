...
for r,d,f in os.walk(working_chunk_location):
	for dire in d:
		if r == working_chunk_location:
			...
			os.system("bsub -q long -W 8:00 -u \"\" \"python /pi/summer.thyme-umw/ari_enamine_conformer_library_tidying/enamine_2.6b_library_tidying/cleanup_chunk_sub.py " + working_chunk + " " +  dire + " \"")
